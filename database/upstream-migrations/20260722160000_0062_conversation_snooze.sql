-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260722160000_0062_conversation_snooze.sql. Do not edit.
...
alter table conversations
  ...
  add column if not exists snoozed_by_user_id uuid references identity.users(id) on delete set null,
