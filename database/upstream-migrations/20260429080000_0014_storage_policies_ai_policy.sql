-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260429080000_0014_storage_policies_ai_policy.sql. Do not edit.
...
create policy "tenant_read_ai_policy" on object_storage.objects for select
  using (
    bucket_id = 'ai-policy'
    and exists (
...
create policy "tenant_write_ai_policy" on object_storage.objects for insert
  with check (
    bucket_id = 'ai-policy'
    and exists (
      select 1 from public.user_organizations uo
...
create policy "tenant_delete_ai_policy" on object_storage.objects for delete
  using (
    bucket_id = 'ai-policy'
    and exists (
      select 1 from public.user_organizations uo
