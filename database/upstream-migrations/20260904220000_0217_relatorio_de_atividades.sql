-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260904220000_0217_relatorio_de_atividades.sql. Do not edit.
...
--
-- NOMES não saem daqui: `identity.users` não é legível por `authenticated`, e o
