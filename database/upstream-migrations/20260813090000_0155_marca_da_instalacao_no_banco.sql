-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260813090000_0155_marca_da_instalacao_no_banco.sql. Do not edit.
-- ============================================================================
...
-- ─── `updated_by` sem FK ────────────────────────────────────────────────────
--
-- É carimbo de PROVENIÊNCIA, não vínculo. Um `references identity.users on delete
...
comment on table public.platform_branding is
  'Marca da INSTALAÇÃO (login, e-mail, 500) — linha única id=1. Semeada do .env na primeira leitura; o .env continua sendo a rede de segurança de rollback. Lida/escrita só server-side (crm_service). Ver lib/branding/instalacao.ts.';
