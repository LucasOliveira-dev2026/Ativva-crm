-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260725050000_0075_score_sai_do_lead_para_tabela_propria.sql. Do not edit.
...
begin
  if exists (
    ...
    execute 'alter publication crm_realtime drop table public.crm_lead_scores';
  end if;
end $$;
