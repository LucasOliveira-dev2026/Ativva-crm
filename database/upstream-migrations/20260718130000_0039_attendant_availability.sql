-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260718130000_0039_attendant_availability.sql. Do not edit.
...
--   INSERT/UPDATE/DELETE: a própria linha (user_id = fortis.current_user_id() + membro) OU
