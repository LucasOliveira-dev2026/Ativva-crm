-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260918210000_0306_google_ads_captura_de_clique.sql. Do not edit.
...
comment on table public.google_ads_landing_pages is
  'Configuração da landing page de captura de gclid, por organização: para qual WhatsApp e com qual texto pré-preenchido ela redireciona. Server-side only: RLS ligada sem policies e grants revogados de crm_anonymous/crm_authenticated — não guarda segredo, mas nenhuma tela lê pelo client ainda.';
