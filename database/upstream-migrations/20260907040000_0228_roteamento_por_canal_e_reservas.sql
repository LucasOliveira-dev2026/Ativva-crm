-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260907040000_0228_roteamento_por_canal_e_reservas.sql. Do not edit.
...
begin
 if fortis.current_user_id() is null or not public.fn_role_at_least(p_org,'manager') or not public.fn_support_write_allowed(p_org)
...
begin
 if fortis.current_user_id() is null or not public.fn_role_at_least(p_org,'admin') or not public.fn_support_write_allowed(p_org)
