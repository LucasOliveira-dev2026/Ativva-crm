-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260915213849_0264_vocabulario_de_tags.sql. Do not edit.
...
-- fato.
--
-- O que a torna segura: `fortis.current_user_id()` tem de passar em
...
revoke execute on function public.fn_vocabulario_de_tags_operar(uuid, text, text, text) from public, crm_anonymous;
grant  execute on function public.fn_vocabulario_de_tags_operar(uuid, text, text, text) to crm_authenticated, crm_service;
