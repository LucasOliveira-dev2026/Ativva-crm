-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260925170000_0414_redact_unificado_chama_a_cascata.sql. Do not edit.
...
--
--   * autoridade — `fortis.current_user_id()`, suporte de escrita, papel `admin` da
