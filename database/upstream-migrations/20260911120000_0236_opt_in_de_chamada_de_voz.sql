-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260911120000_0236_opt_in_de_chamada_de_voz.sql. Do not edit.
-- ============================================================================
...
create table if not exists public.org_voice_calls (
  ...
  risco_aceito_por uuid references identity.users(id) on delete set null,
...
revoke all on public.org_voice_calls from crm_anonymous;
