-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260911170000_0238_convites_de_time_persistidos.sql. Do not edit.
...
comment on column public.team_invites.inviter_name is
  'Snapshot do nome de quem convidou. identity.users não é acessível via PostgREST; resolver na hora seria N chamadas GoTrue por render.';
