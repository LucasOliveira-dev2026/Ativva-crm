-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260429090000_0015_conversations_rag_optin.sql. Do not edit.
...
alter table public.conversations
  ...
  add column if not exists usable_for_rag_marked_by uuid references identity.users(id),
