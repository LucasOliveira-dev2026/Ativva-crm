-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260820030000_0164_atribuicao_de_anuncio.sql. Do not edit.
...
alter function public.fn_estampar_atribuicao_de_anuncio(uuid, text, jsonb) owner to crm_owner;
...
-- de sessão precisa.
revoke execute on function public.fn_estampar_atribuicao_de_anuncio(uuid, text, jsonb) from public, crm_anonymous, crm_authenticated;
grant execute on function public.fn_estampar_atribuicao_de_anuncio(uuid, text, jsonb) to crm_service;
