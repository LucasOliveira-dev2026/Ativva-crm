-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260805180000_0108_revoke_definer_exposto.sql. Do not edit.
...
revoke execute on function public.fn_is_platform_admin() from public, crm_anonymous;
revoke execute on function public.fn_user_org_ids() from public, crm_anonymous;
revoke execute on function public.fn_user_role_in_org(uuid) from public, crm_anonymous;
revoke execute on function public.fn_user_role_in(uuid) from public, crm_anonymous;
revoke execute on function public.fn_role_at_least(uuid, text) from public, crm_anonymous;
revoke execute on function public.fn_publish_ai_agent_version(uuid, uuid, uuid) from public, crm_anonymous;
revoke execute on function public.fn_emit_conversation_routing() from public, crm_anonymous;
revoke execute on function public.rls_auto_enable() from public, crm_anonymous;
...
revoke execute on function public.rls_auto_enable() from crm_authenticated;
...
grant execute on function public.rls_auto_enable() to crm_service;
