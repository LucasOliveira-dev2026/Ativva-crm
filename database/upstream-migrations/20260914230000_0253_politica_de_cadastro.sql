-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260914230000_0253_politica_de_cadastro.sql. Do not edit.
...
comment on table public.platform_settings is
  'Configuração da INSTALAÇÃO (não do tenant) — linha única id=1. Hoje só a política de cadastro. Lida/escrita apenas server-side (crm_service); a ausência da linha significa o default, que é o comportamento anterior à 0253. Ver lib/auth/politica-de-cadastro.ts.';
