-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260906020000_0222_fronteira_do_atendimento.sql. Do not edit.
...
alter table public.demandas add column if not exists encerrada_por uuid references identity.users(id) on delete set null;
