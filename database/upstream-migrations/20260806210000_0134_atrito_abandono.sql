-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260806210000_0134_atrito_abandono.sql. Do not edit.
...
revoke execute on function public.fn_atrito_metrics(uuid, timestamptz, timestamptz, int) from crm_anonymous;
