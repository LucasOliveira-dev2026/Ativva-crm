-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260923140000_0390_fotos_no_catalogo.sql. Do not edit.
-- ============================================================================
...
-- entrega. Nenhuma policy em `object_storage.objects`: só o `service_role` lê e grava,
