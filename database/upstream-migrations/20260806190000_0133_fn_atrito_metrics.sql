-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260806190000_0133_fn_atrito_metrics.sql. Do not edit.
...
revoke execute on function public.fn_atrito_metrics(uuid, timestamptz, timestamptz) from crm_anonymous;
