-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260906030000_0223_origem_imutavel_do_evento.sql. Do not edit.
...
begin
  ...
  if fortis.current_user_id() is not null and p_event_type = 'message.received' then
