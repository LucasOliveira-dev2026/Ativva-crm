-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260904011000_0209_mover_em_lote_sem_colidir_posicao.sql. Do not edit.
...
revoke execute on function public.fn_mover_leads_em_lote(uuid, uuid[], uuid) from crm_anonymous;
