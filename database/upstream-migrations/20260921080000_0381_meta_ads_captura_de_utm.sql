-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260921080000_0381_meta_ads_captura_de_utm.sql. Do not edit.
...
comment on table public.meta_ads_landing_pages is
  'Configuração do redirecionamento de captura de UTM, por organização: para qual WhatsApp e com qual texto pré-preenchido a rota pública manda quem clicou no botão da landing page. Server-side only: RLS ligada sem policies e grants revogados de crm_anonymous/crm_authenticated.';
