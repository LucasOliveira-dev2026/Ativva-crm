-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260810150000_0143_guardrail_layers_escrita_de_admin.sql. Do not edit.
-- ============================================================================
...
revoke all on public.org_guardrail_layers from crm_anonymous;
