-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260820170000_0167_poda_da_fila_e_expurgo_do_audit.sql. Do not edit.
...
grant execute on function public.fn_podar_fila_de_jobs(int, int) to crm_service;

revoke execute on function public.fn_expurgar_auditoria_vencida(int, int)
  from public, crm_anonymous, crm_authenticated;
grant execute on function public.fn_expurgar_auditoria_vencida(int, int) to crm_service;
