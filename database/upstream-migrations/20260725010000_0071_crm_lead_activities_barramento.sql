-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260725010000_0071_crm_lead_activities_barramento.sql. Do not edit.
...
do $$ begin
  if not exists (select 1 from pg_publication where pubname='crm_realtime') then
...
begin
  if not exists (
    select 1 from pg_publication_tables
     where pubname='crm_realtime' and schemaname='public' and tablename='crm_lead_activities'
  ) then
    alter publication crm_realtime add table public.crm_lead_activities;
  end if;
end $$;
