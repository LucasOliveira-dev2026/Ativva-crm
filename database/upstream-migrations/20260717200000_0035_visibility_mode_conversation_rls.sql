-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260717200000_0035_visibility_mode_conversation_rls.sql. Do not edit.
...
-- blindado (lê organizations.settings e resolve role via fortis.current_user_id()); EXECUTE
...
as $$
  select case
    ...
    when p_assigned_to_user_id = fortis.current_user_id() then true                 -- as suas
    else case coalesce(
...
-- tem fortis.current_user_id() null e é dispensado — call site já confiável). Corpo idêntico ao
