-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260827183000_0199_push_subscriptions_rbac.sql. Do not edit.
-- 0176 — push_subscriptions: policy ALL sem fn_role_at_least.
--
-- A 0168 criou a tabela com RLS da própria linha (user_id = fortis.current_user_id()), mas a
...
create policy push_subscriptions_own on public.push_subscriptions
  ...
  using (
    ...
    and user_id = fortis.current_user_id()
