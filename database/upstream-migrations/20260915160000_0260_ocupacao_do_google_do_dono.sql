-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260915160000_0260_ocupacao_do_google_do_dono.sql. Do not edit.
...
--   · `fortis.current_user_id() is null` é chamada SEM `sub` no JWT — na prática o
...
-- pertencimento pelo `fortis.current_user_id()` do JWT, que a definer não troca.
--
...
as $$
  select e.starts_at, e.ends_at, e.transparency, e.status, c.status
   ...
   where (fortis.current_user_id() is null
