-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260915140000_0258_audit_log_so_recebe_linha.sql. Do not edit.
...
-- `identity.users` e `api_tokens` também não: a ação referencial roda como o dono da
