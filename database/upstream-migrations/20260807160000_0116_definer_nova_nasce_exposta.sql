-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260807160000_0116_definer_nova_nasce_exposta.sql. Do not edit.
...
begin
  ...
  if to_regrole('crm_anonymous') is null then
    return;
  end if;
