-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260918100000_0279_caso_so_nasce_do_motor.sql. Do not edit.
-- ════════════════════════════════════════════════════════════════════════════
...
--
--    A reserva SOZINHA não fecha nada: ela só barra quem tem `fortis.current_user_id()`, e
...
begin
  ...
  if fortis.current_user_id() is not null and p_event_type in (
