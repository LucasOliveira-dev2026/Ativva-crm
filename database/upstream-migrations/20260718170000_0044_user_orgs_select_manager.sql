-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260718170000_0044_user_orgs_select_manager.sql. Do not edit.
...
create policy "user_orgs_select" on public.user_organizations
  for select using (
    (user_id = fortis.current_user_id())
