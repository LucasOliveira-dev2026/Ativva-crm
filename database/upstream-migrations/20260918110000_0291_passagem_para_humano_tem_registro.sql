-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260918110000_0291_passagem_para_humano_tem_registro.sql. Do not edit.
-- ═══════════════════════════════════════════════════════════════════════════
...
create table if not exists public.passagens_de_atendimento (
  ...
  reconhecido_por  uuid references identity.users(id) on delete set null,
