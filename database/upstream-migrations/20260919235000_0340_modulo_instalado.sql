-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260919235000_0340_modulo_instalado.sql. Do not edit.
...
create table if not exists public.modulos_instalados (
  ...
  instalado_por uuid references identity.users(id) on delete set null,
