-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260429110001_0019_lgpd_cascade_redact_rpc.sql. Do not edit.
...
revoke execute on function public.fn_lgpd_cascade_redact_contact(uuid, uuid, uuid) from crm_anonymous;
