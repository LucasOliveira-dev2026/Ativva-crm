-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260727000000_0086_knowledge_searches.sql. Do not edit.
...
-- para JWT anônimo (fortis.current_user_id() null => fn_user_org_ids() vazio), mas o grant que
...
revoke all on public.knowledge_searches from crm_anonymous;
