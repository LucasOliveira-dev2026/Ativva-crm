-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260505140000_0023_ai_agents_module.sql. Do not edit.
...
revoke all on public.ai_provider_credentials from crm_anonymous;
...
revoke all on public.ai_provider_credentials_safe from crm_anonymous;
...
revoke all on public.ai_agent_versions from crm_anonymous;
...
revoke all on public.ai_agent_runs from crm_anonymous;
