-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260920001000_0347_modulo_voip.sql. Do not edit.
-- ============================================================
...
create table if not exists public.phone_numbers (
  ...
  fallback_user_id uuid references identity.users(id) on delete set null,
