-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260429032132_0010_ai_rag_handoff_columns_and_rpcs.sql. Do not edit.
-- =============================================================================
...
revoke execute on function public.retrieve_top_k_chunks(uuid, uuid, vector, int, real) from crm_anonymous;
...
revoke execute on function public.activate_kb_version(uuid, uuid) from crm_anonymous;
