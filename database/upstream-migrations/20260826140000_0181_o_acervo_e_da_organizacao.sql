-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260826140000_0181_o_acervo_e_da_organizacao.sql. Do not edit.
-- ============================================================================
...
--   * o gate de membership só morde quando há `fortis.current_user_id()`. O engine roda com
...
revoke all on table public.ai_knowledge_sources  from crm_anonymous;
revoke all on table public.ai_knowledge_versions from crm_anonymous;
revoke all on table public.ai_chunks             from crm_anonymous;
revoke all on table public.ai_faq_items          from crm_anonymous;
