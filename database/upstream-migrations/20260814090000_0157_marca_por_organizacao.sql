-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260814090000_0157_marca_por_organizacao.sql. Do not edit.
-- ============================================================================
...
-- `fortis.current_user_id()`). Essa fuga é vigiada por
