-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260717210000_0036_visibility_mode_lead_rls.sql. Do not edit.
...
-- fortis.current_user_id()); EXECUTE revogado de anon/public (lição G4-00) — só
...
as $$
  select case
    ...
    when p_owner_user_id = fortis.current_user_id() then true                       -- os seus
    else case coalesce(
