-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260728130000_0089_system_self_update.sql. Do not edit.
...
create table if not exists public.system_version (
  ...
  update_requested_by uuid references identity.users(id) on delete set null,
