-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260717150000_0032_conversation_assignee_kind.sql. Do not edit.
...
--    service_role (worker/handoff, fortis.current_user_id() null). anon tem EXECUTE
...
--    fortis.current_user_id() null — sem o revoke, o PostgREST exporia a função como RPC
...
--    authenticated precisa ser membro ativo da org; fortis.current_user_id() null é o path
...
as $$
  select uo.role
   ...
   where uo.user_id = p_user
     ...
     and (
       fortis.current_user_id() is null
       or exists (
         select 1 from public.user_organizations me
          where me.user_id = fortis.current_user_id()
...
-- (anon key vai pro browser) e o ramo fortis.current_user_id() null responde a request
