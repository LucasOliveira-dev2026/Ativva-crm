-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260904051000_0213_conversoes_de_anuncio.sql. Do not edit.
...
comment on table public.ad_platform_connections is
  'Conexão da organização com a plataforma de anúncios, para reportar conversões offline. Server-side only: RLS ligada sem policies e grants revogados de crm_anonymous/crm_authenticated. O token nunca volta ao browser; a tela devolve apenas se existe.';
