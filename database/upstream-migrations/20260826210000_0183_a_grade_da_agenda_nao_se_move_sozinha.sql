-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260826210000_0183_a_grade_da_agenda_nao_se_move_sozinha.sql. Do not edit.
-- ============================================================================
-- 0183 — A GRADE NÃO ATUALIZA SOZINHA, E O DIAGNÓSTICO VAI PARA O LUGAR ERRADO
--
-- `publication crm_realtime` é um array fechado, e `calendar_appointments`
...
begin
  if not exists (
    select 1 from pg_publication where pubname = 'crm_realtime'
  ) then
    create publication crm_realtime;
  end if;
