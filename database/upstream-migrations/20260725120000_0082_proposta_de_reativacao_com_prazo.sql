-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260725120000_0082_proposta_de_reativacao_com_prazo.sql. Do not edit.
...
begin
  if not exists (
    ...
    execute 'alter publication crm_realtime add table public.crm_lead_reactivations';
  end if;
end $$;
