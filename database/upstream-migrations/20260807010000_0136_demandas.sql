-- GENERATED by scripts/fortis/baseline/build.mjs from supabase/migrations/20260807010000_0136_demandas.sql. Do not edit.
...
create table if not exists public.demandas (
  ...
  dono_user_id uuid references identity.users(id) on delete set null,
